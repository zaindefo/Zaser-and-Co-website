...
import { Anton, Bebas_Neue, DM_Mono, Instrument_Serif, Plus_Jakarta_Sans } from 'next/font/google'
import './globals.css'
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${anton.variable} ${bebas.variable} ${instrument.variable} ${jakarta.variable} ${dmMono.variable}`}>
      <head>
        <GoogleTagManager />
        <GoogleAnalytics />
